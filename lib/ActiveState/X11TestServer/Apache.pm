package ActiveState::X11TestServer::Apache;
...
my $manager = ActiveState::X11TestServer::Apache::Manager->new;
...
package ActiveState::X11TestServer::Apache::Manager;
use strict;
...
ActiveState::X11TestServer::Apache - Dynamic X server allocation

=head1 SYNOPSIS

  in httpd.conf:
    PerlModule ActiveState::X11TestServer::Apache

=head1 DESCRIPTION

This modules is the dynamic backend companion to L<ActiveState::X11TestServer>

=head1 SEE ALSO

<ActiveState::X11TestServer>
